...
const TEAMS: Record<string, { flag: string; he: string; code: string }> = {
  ...
  "Turkiye":             { flag: "🇹🇷", he: "טורקיה", code: "tr" },
  ...
  "Bosnia and Herzegovina": { flag: "🇧🇦", he: "בוסניה", code: "ba" },
  ...
  "Curacao":             { flag: "🇨🇼", he: "קוראסאו", code: "cw" },
  ...
  "DR Congo":            { flag: "🇨🇩", he: "קונגו", code: "cd" },
  "Cape Verde":          { flag: "🇨🇻", he: "כף ורדה", code: "cv" },
