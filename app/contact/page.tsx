...
function ContactPageContent() {
  ...
  async function checkAuth() {
    ...
    if (!data?.full_name || !data?.phone || !data?.country) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!message.trim()) {
      toast.error(isHe ? "יש לכתוב סיבה" : "Please write a reason");
      return;
    }
    ...
    if (error) {
      toast.error(isHe ? "שליחה נכשלה" : "Failed to submit");
      return;
    }
      ...
      <main style={{ minHeight: "100vh" }}>
        ...
        >
          <div style={{ ...card, padding: "32px", textAlign: "center" }}>
            ...
            >
              {isHe
                ? "כדי לדווח על מודעה, עליך להיות מחובר עם פרופיל מלא."
                : "To report a listing, you need to be logged in with a complete profile."}
            </p>
            <div
              style={{ display: "flex", flexDirection: "column", gap: "10px" }}
            >
              <Link
                href={`/auth?redirect=/contact?listingId=${listingId}&matchId=${matchId}`}
                style={{
                  display: "block",
                  padding: "12px",
                  background: C.usa,
      ...
      <main style={{ minHeight: "100vh" }}>
        ...
        >
          <div style={{ ...card, padding: "32px", textAlign: "center" }}>
            ...
            >
              {isHe
                ? "כדי לדווח על מודעות, יש להשלים את פרטי הפרופיל שלך."
                : "To report listings, you need to complete your profile first."}
            </p>
            <div
              style={{ display: "flex", flexDirection: "column", gap: "10px" }}
            >
      ...
      <main style={{ minHeight: "100vh" }}>
        ...
        >
          <div style={{ ...card, padding: "40px 32px", textAlign: "center" }}>
            ...
            >
              {isHe
                ? "נבדוק את המודעה בהקדם. תודה שעזרת לשמור על הקהילה."
                : "We'll review the listing soon. Thanks for helping keep the community safe."}
            </p>
            <div
              style={{ display: "flex", flexDirection: "column", gap: "10px" }}
            >
    ...
    <main style={{ minHeight: "100vh" }}>
      ...
      >
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          >
            {isHe
              ? "לוקחים דיווחים ברצינות. תאר את הבעיה שמצאת."
              : "We take reports seriously. Describe the issue you found."}
          </p>
        </div>
        ...
        >
          <div>
            ...
            <textarea
              ...
              placeholder={
                isHe
                  ? "למה המודעה לא אמינה או בעייתית?"
                  : "Why is this listing suspicious or problematic?"
              }
